...
<template>
            ...
            >
                <div style="display: flex; gap: var(--sp-6)">
                    <div>
                        ...
                        <StatusBadge
                            :status="
                                stack.state === 'RunningPrimary'
                                    ? 'running'
                                    : stack.state === 'RunningBackup'
                                      ? 'warning'
                                      : 'stopped'
                            "
                            :label="stack.state"
    ...
    <div v-else style="color: var(--text-disabled); font-size: 11px">
        Loading stack…
    </div>
</template>
